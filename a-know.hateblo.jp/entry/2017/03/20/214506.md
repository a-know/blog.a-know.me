...
前回の [http://blog.a-know.me/entry/2017/03/16/215659:title] の続き。今後いくつかのコンテナイメージを作っていくにあたって「ヒミツにしておきたい情報を含んだコンテナ」を作ることもありそうなので、そんなイメージの登録はプライベートなレジストリにしたい・それなら Amazon ECR はどうだろう。というのが経緯。
